            ...
            fetch(api)
                ...
                fetch(forecastApi)
                    ...
                    .then(data => {
                        ...
                        maxTemp.textContent = 'Max temp: ' + Math.round(data.list[0].main.temp_max) + ' F';
                        realFeel.textContent = 'Real feel: ' + Math.round(data.list[0].main.feels_like) + ' F';
                        minTemp.textContent = 'Min temp: ' + Math.round(data.list[0].main.temp_min) + ' F';
                    })
                    ...
                    .then(data => {
                        ...
                        tomForecastDescription.textContent = data.list[8].weather[0].description;
                        tomMaxTemp.textContent = 'Max temp: ' + Math.round(data.list[8].main.temp_max) + ' F';
                        tomRealFeel.textContent = 'Real feel: ' + Math.round(data.list[8].main.feels_like) + ' F';
                        tomMinTemp.textContent = 'Min temp: ' + Math.round(data.list[8].main.temp_min) + ' F';
                    })
                    ...
                    .then(data => {
                        ...
                        datForecastDescription.textContent = data.list[16].weather[0].description;
                        datMaxTemp.textContent = 'Max temp: ' + Math.round(data.list[16].main.temp_max) + ' F';
                        datRealFeel.textContent = 'Real feel: ' + Math.round(data.list[16].main.feels_like) + ' F';
                        datMinTemp.textContent = 'Min temp: ' + Math.round(data.list[16].main.temp_min) + ' F';
                    })
        })
    }
})